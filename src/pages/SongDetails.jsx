...
const SongDetails = () => {
    ...
    <Loader title="Seartching song details" />;
            ...
            <div className="mb-10">
                ...
                <div className="mt-5">
                    {songData?.sections[1].type === 'LYRICS' ? songData?.sections[1].text.map((line, i) => (
                        <p className="text-gray-400 tect-base my-1" key={i}>{line}</p>
                    )) : <p className="text-gray-400 tect-base my-1"> Sorry, no lyrics found!</p>
                    }
                </div>
            </div>
            <RelatedSongs
